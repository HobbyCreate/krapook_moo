...
export default function Register() {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (axios.isAxiosError(err)) {
                ...
                setError(serverError?.error || 'เกิดข้อผิดพลาดในการลงทะเบียน');
    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-emerald-900 via-teal-900 to-gray-900 flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-md p-8 rounded-3xl shadow-2xl border border-gray-100 my-6">
                ...
                <div className="flex flex-col items-center mb-6">
                    ...
                    <p className="text-center text-xs text-gray-500 mt-1">
                        กรอกข้อมูลของคุณเพื่อเริ่มต้นใช้งาน Krapook Moo
                    </p>
                </div>
